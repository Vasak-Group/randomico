<template>
    <footer id="footer">
                    ...
                    <div class="col-lg-4 col-md-6 footer-links text-center">
                        ...
                        <ul>
                            <li>
                                ...
                                <a target="_black" href="https://qrgenerator.vasak.net.ar/">QR
                                    Generator</a>
                            </li>
                            <li>
                                <em class="fa fa-chevron-right"></em>
                            ...
                            <li>
                                <em class="fa fa-chevron-right"></em>
                                <a target="_black" href="https://wppgenerator.vasak.net.ar/">WhatsApp
                                    Generator</a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="container py-4">
            <div class="copyright"> © <span class="v-font">Vasak group</span>.
                Todos los dertechos reservados. </div>
